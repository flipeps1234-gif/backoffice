...
export default function AboutContent() {
  ...
  return (
    <main className="mx-auto w-full max-w-[40rem] px-4 py-8">
      ...
      <h1 className="text-4xl font-semibold tracking-tight">{t("site.aboutTitle")}</h1>
      <p className="mt-4 text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">{t("site.aboutIntro")}</p>
      <p className="mt-3 text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">{t("site.aboutWhat")}</p>
